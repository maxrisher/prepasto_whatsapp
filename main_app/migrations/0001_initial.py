    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usda_food_data_central_id', models.PositiveIntegerField(blank=True, null=True)),
                ...
                ('similar_dishes', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=255), size=None)),
                ('fndds_categories', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=None)),
                ('fndds_and_sr_legacy_google_search_results', django.contrib.postgres.fields.ArrayField(base_field=models.IntegerField(), size=None)),
